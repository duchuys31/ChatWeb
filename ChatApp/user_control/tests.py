...
#         # tạo chuỗi token hợp lệ
        # token = jwt.encode({'data': '1111'}, settings.SECRET_KEY, algorithm="HS256")
        # detoken = jwt.decode(token, settings.SECRET_KEY, algorithms="HS256")
#         # print('\nen\n' + token + '\nen\n')
#         # print(detoken)
        

#         # kiểm tra phương thức verify_token trả về giá trị khác None và có các thông tin cần thiết trong decoded_data
#         decoded_data = Authentication.verify_token(token)
#         self.assertIsNotNone(decoded_data) # kiểm tra xem kết quả trả về có khác None không
