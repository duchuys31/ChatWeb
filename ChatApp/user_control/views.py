...
from .serializers import (
    LoginSerializer, RegisterSerializer, RefreshSerializer, UserProfile, UserProfileSerializer, FavoriteSerializer
)
from django.contrib.auth import authenticate
from rest_framework.response import Response
from .authentication import Authentication
from ChatApp.custom_methods import IsAuthenticatedCustom
...
class RefreshView(APIView):
    ...
    def post(self, request):
        ...
        serializer.is_valid(raise_exception=True)
        # print('$')
        # print(type(serializer.validated_data["refresh"]))
        # print('$')
        ...
        #
        if not Authentication.verify_token(serializer.validated_data.get("refresh")):
...
class UserProfileView(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if keyword:
            ...
            try:
                # print(self.queryset.filter(query).filter(**data).exclude(
